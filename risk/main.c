...
#define dimgrey al_map_rgb(105,105,105)
...
void nobati(int nobat){
    font = al_load_ttf_font("D:\\poroje\\risk\\tahoma.ttf", 20, 0);
    al_draw_filled_rectangle(20,450 -75/2.0,130,450+75/2.0 ,deeppink);
    if(nobat == 1)
        al_draw_rectangle(20,450 -75/2.0,130,450+75/2.0,chocolate,10);
    else if(nobat == 2)
        al_draw_rectangle(20,450 -75/2.0,130,450+75/2.0,aqua,10);
    else if(nobat == 3)
        al_draw_rectangle(20,450 -75/2.0,130,450+75/2.0,blue_violet,10);
    else if(nobat == 4)
        al_draw_rectangle(20,450 -75/2.0,130,450+75/2.0,teal,10);
    al_draw_textf(font,black,40  , 430, 0 , "person%d",nobat);
    al_flip_display();
}

void soldier(int tedad , int nobat){
    font = al_load_ttf_font("D:\\poroje\\risk\\tahoma.ttf", 20, 0);
...
void get_sarbaz(int tedad , int p ,int nobat){
    ...
    if(tedad == 2){
        if(nobat == 1) {
            ...
            al_draw_rectangle(375, 820, 525, 905, chocolate, 5);
            if(p > 9)
            ...
            al_draw_rectangle(550, 820, 700, 905, aqua, 5);
            if(p > 9)
        ...
        if(nobat == 1) {
            ...
            al_draw_rectangle(725, 820, 875, 905, blue_violet, 5);
            if(p > 9)
        ...
        if(nobat == 1) {
            ...
            al_draw_rectangle(900, 820, 1050, 905, teal, 5);
            if(p > 9)
...
int darsadbazikonha(int tedad){
    ...
    if(tedad == 2){
        ...
        if(tedad == 2){
            ...
            for (int i = 1; i <= 29; ++i) {
                if(i <= p1){
                    ...
                    al_draw_filled_rectangle(1390 - (i*10),25,1390 - ((i-1)*10),35,dimgrey);
                }
            ...
            for (int i = 1; i <= 29; ++i) {
                if(i <= p2){
                    ...
                    al_draw_filled_rectangle(1390 - (i*10),95,1390 - ((i-1)*10),105,dimgrey);
                }
        ...
        al_draw_filled_rectangle(0,0,1500,90,moccasin);
        for (int i = 0; i < 6; ++i) {
            for (int j = 0; j < 7; ++j) {
                if(person1[j][i] != 0){
                    p1 += 1;
...
//    if(tedad == 2){
        if(person == 1){
            ...
            if(person3[j_red][i_red - 1] != 0 && select(150 * (i_red - 1 + 1), 100 * (j_red + 1), 150 * (i_red - 1 + 1) + 150, 100 * (j_red + 1) + 100, xmouse, ymouse) == 1){
                ...
                draw_circle(150 * (i_red + 1), 100 * (j_red + 1));
                draw_dorost_circle(i_red -1 ,j_red ,2);
                batel(tedad,person,i_red,j_red,i_red - 1, j_red,3);
                return 1;
                ...
                draw_circle(150 * (i_red + 1), 100 * (j_red + 1));
                draw_dorost_circle(i_red,j_red - 1,2);
                batel(tedad,person,i_red,j_red,i_red , j_red- 1,3);
                return 1;
            } else if(person3[j_red + 1][i_red] != 0 && select(150 * (i_red + 1), 100 * (j_red + 1 + 1), 150 * (i_red + 1) + 150, 100 * (j_red + 1+ 1) + 100, xmouse, ymouse) == 1){
                destroy_dorost_circle();
                draw_circle(150 * (i_red + 1), 100 * (j_red + 1));
            ...
            if(person4[j_red][i_red - 1] != 0 && select(150 * (i_red - 1 + 1), 100 * (j_red + 1), 150 * (i_red - 1 + 1) + 150, 100 * (j_red + 1) + 100, xmouse, ymouse) == 1){
                ...
                draw_circle(150 * (i_red + 1), 100 * (j_red + 1));
                draw_dorost_circle(i_red -1 ,j_red ,2);
                batel(tedad,person,i_red,j_red,i_red - 1, j_red,4);
                return 1;
                ...
                draw_circle(150 * (i_red + 1), 100 * (j_red + 1));
                draw_dorost_circle(i_red,j_red - 1,2);
                batel(tedad,person,i_red,j_red,i_red , j_red- 1,4);
                return 1;
            } else if(person4[j_red + 1][i_red] != 0 && select(150 * (i_red + 1), 100 * (j_red + 1 + 1), 150 * (i_red + 1) + 150, 100 * (j_red + 1+ 1) + 100, xmouse, ymouse) == 1){
                destroy_dorost_circle();
                draw_circle(150 * (i_red + 1), 100 * (j_red + 1));
            ...
            if(person1[j_red][i_red - 1] != 0 && select(150 * (i_red - 1 + 1), 100 * (j_red + 1), 150 * (i_red - 1 + 1) + 150, 100 * (j_red + 1) + 100, xmouse, ymouse) == 1){
                ...
                draw_circle(150 * (i_red + 1), 100 * (j_red + 1));
                draw_dorost_circle(i_red -1 ,j_red ,2);
                batel(tedad,person,i_red,j_red,i_red - 1, j_red,1);
                return 1;
                ...
                draw_circle(150 * (i_red + 1), 100 * (j_red + 1));
                draw_dorost_circle(i_red,j_red - 1,2);
                batel(tedad,person,i_red,j_red,i_red , j_red- 1,1);
                return 1;
            } else if(person1[j_red + 1][i_red] != 0 && select(150 * (i_red + 1), 100 * (j_red + 1 + 1), 150 * (i_red + 1) + 150, 100 * (j_red + 1+ 1) + 100, xmouse, ymouse) == 1){
                destroy_dorost_circle();
                draw_circle(150 * (i_red + 1), 100 * (j_red + 1));
                                        ...
                                        if (event.type == ALLEGRO_EVENT_MOUSE_BUTTON_UP) {
                                            if(tedad_gabegaie == 0 &&select_map3(event.mouse.x,event.mouse.y,nobat,i_gabegaie,j_gabegaie , &i_magsad , &j_magsad)){
                                                ...
                                                while (1){
                                                    ...
                                                    if (event.type == ALLEGRO_EVENT_MOUSE_BUTTON_UP) {
                                                        if(select(150 * (i_magsad + 1), 100 * (j_magsad + 1), 150 * (i_magsad + 1) + 150, 100 * (j_magsad + 1) + 100,event.mouse.x,event.mouse.y) == 1){
                                                            if(person2[j_gabegaie][i_gabegaie] > 1 && person2[j_magsad][i_magsad] != 0){
                                                                person2[j_gabegaie][i_gabegaie] -= 1;
                                                                person2[j_magsad][i_magsad] += 1;
                                                                gereftan_sarzamin(i_gabegaie,j_gabegaie,person2[j_gabegaie][i_gabegaie],nobat);
                                                                gereftan_sarzamin(i_magsad,j_magsad,person2[j_magsad][i_magsad],nobat);
                                                                draw_circle(150*(i_gabegaie+1),100*(j_gabegaie+1));
                                                                draw_dorost_circle(i_magsad,j_magsad,2);
                                                                al_flip_display();
                                                            } else {
                                        ...
                                        if (event.type == ALLEGRO_EVENT_MOUSE_BUTTON_UP) {
                                            if(tedad_gabegaie == 0 &&select_map3(event.mouse.x,event.mouse.y,nobat,i_gabegaie,j_gabegaie , &i_magsad , &j_magsad)){
                                                ...
                                                while (1){
                                                    ...
                                                    if (event.type == ALLEGRO_EVENT_MOUSE_BUTTON_UP) {
                                                        if(select(150 * (i_magsad + 1), 100 * (j_magsad + 1), 150 * (i_magsad + 1) + 150, 100 * (j_magsad + 1) + 100,event.mouse.x,event.mouse.y) == 1){
                                                            if(person3[j_gabegaie][i_gabegaie] > 1 && person3[j_magsad][i_magsad] != 0){
                                                                person3[j_gabegaie][i_gabegaie] -= 1;
                                                                person3[j_magsad][i_magsad] += 1;
                                                                gereftan_sarzamin(i_gabegaie,j_gabegaie,person3[j_gabegaie][i_gabegaie],nobat);
                                                                gereftan_sarzamin(i_magsad,j_magsad,person3[j_magsad][i_magsad],nobat);
                                                                draw_circle(150*(i_gabegaie+1),100*(j_gabegaie+1));
                                                                draw_dorost_circle(i_magsad,j_magsad,2);
                                                                al_flip_display();
                                                            } else {
                                        ...
                                        if (event.type == ALLEGRO_EVENT_MOUSE_BUTTON_UP) {
                                            if(tedad_gabegaie == 0 &&select_map3(event.mouse.x,event.mouse.y,nobat,i_gabegaie,j_gabegaie , &i_magsad , &j_magsad)){
                                                ...
                                                while (1){
                                                    ...
                                                    if (event.type == ALLEGRO_EVENT_MOUSE_BUTTON_UP) {
                                                        if(select(150 * (i_magsad + 1), 100 * (j_magsad + 1), 150 * (i_magsad + 1) + 150, 100 * (j_magsad + 1) + 100,event.mouse.x,event.mouse.y) == 1){
                                                            if(person4[j_gabegaie][i_gabegaie] > 1 && person4[j_magsad][i_magsad] != 0){
                                                                person4[j_gabegaie][i_gabegaie] -= 1;
                                                                person4[j_magsad][i_magsad] += 1;
                                                                gereftan_sarzamin(i_gabegaie,j_gabegaie,person4[j_gabegaie][i_gabegaie],nobat);
                                                                gereftan_sarzamin(i_magsad,j_magsad,person4[j_magsad][i_magsad],nobat);
                                                                draw_circle(150*(i_gabegaie+1),100*(j_gabegaie+1));
                                                                draw_dorost_circle(i_magsad,j_magsad,2);
                                                                al_flip_display();
                                                            } else {
